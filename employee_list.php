...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['addTask'])) {
        $newTask = [
            'name' => $_POST['task'],
            'position' => $_POST['owner'],
            'shift' => $_POST['shift'],
            'salary' => $_POST['salary'],
            'address' => $_POST['status'],
            'phone_number' => $_POST['start_date'],
            'age' => $_POST['due_date'],
            'email' => $_POST['completion'],
                        ...
                        <form method="POST">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="completion" name="completion" required>
                                </div>
                                <div class="form-group">
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="editTaskAddress" name="status" required>
                                </div>
                                <div class="form-group">
                                    <label for="editTaskPhone">Phone Number</label>
                                    <input type="text" class="form-control" id="editTaskPhone" name="start_date" required>
                                </div>
                                <div class="form-group">
                                    <label for="editTaskAge">Age</label>
                                    <input type="text" class="form-control" id="editTaskAge" name="due_date" required>
                                </div>
                                <div class="form-group">
                                    <label for="editTaskEmail">Email</label>
                                    <input type="text" class="form-control" id="editTaskEmail" name="completion" required>
                                </div>
                                <div class="form-group">
                                    <label for="start_date">Start Date</label>
