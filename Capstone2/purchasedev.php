<?php
$tasksFile = 'purchasedev_task.json'; // Change the file name for each department
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header('Location: purchasedev.php'); // Redirect to the same department page
    exit();
}
...
<head>
    <meta charset="UTF-8">
    <title>Product Development Department</title> <!-- Change title for each department -->
...
<body>
    ...
    <!-- Main Content -->
    <div class="container">
        <h1 class="my-4">Product Development Department</h1> <!-- Change header for each department -->
