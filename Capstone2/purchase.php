<?php
$tasksFile = 'purchase_task.json'; // Change the file name for each department
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header('Location: purchase.php'); // Redirect to the same department page
    exit();
}
...
<head>
    <meta charset="UTF-8">
    <title>Purchase Department</title> <!-- Change title for each department -->
...
<body>
    ...
    <!-- Main Content -->
    <div class="container">
        <h1 class="my-4">Purchase Department</h1> <!-- Change header for each department -->
