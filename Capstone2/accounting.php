<?php
$tasksFile = 'accountiing_tasks.json'; // Change the file name for each department
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header('Location: accounting.php'); // Redirect to the same department page
    exit();
}
...
<head>
    <meta charset="UTF-8">
    <title>Accounting Department</title> <!-- Change title for each department -->
...
<body>
    ...
    <!-- Main Content -->
    <div class="container">
        <h1 class="my-4">Accounting Department</h1> <!-- Change header for each department -->
